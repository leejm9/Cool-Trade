		...
		<form action="<%=contextPath%>/signup.me" method="post">
			...
			<div class="form-group">
				...
				<div class="input-group">
					<input type="text" id="userId" name="userId" placeholder="아이디"
						required>
					<button id="checkUserIdBtn" type="button"
						onclick="btnCheckUserId()">중복확인</button>
				</div>
			...
			<div class="form-group">
				<div class="input-group">
					<input type="text" id="email" name="email" placeholder="이메일 주소"
						required>
					<button type="button" id="getVerifyCode"
						onclick="sendVerifyCode();">인증번호받기</button>
				</div>
			...
			<div class="form-group">
				<div class="input-group">
					...
					<button type="button" id="getVerifyCode"
						onclick="checkVerifyCode();">인증번호확인</button>
				</div>
			...
			<div class="checkbox-group">
				<input type="checkbox" id="agreeAll" name="terms_all"> <label
					for="agreeAll">[필수] 인증 약관 전체 동의</label>
			</div>
			...
			<div class="terms-container">
				...
				<div class="checkbox-group">
					<div class="checkbox-area">
						<input type="checkbox" id="personalInfo2" name="telecomInfo"
							class="sub-agree"> <label for="personalInfo2">만
							14세 이상</label>
					</div>
				...
				<details id="personalInfoDetails1">
					<summary></summary>
					<p style="font-size: 12px;">쿨거래 이용약관(필수) 쿨거래는 이용자의 권익 및 개인정보
						보호에 만전을 기하고자 관계법령의 규정을 반영하여 쿨거래에 회원가입을 신청하시는 이용자분들께 아래와 같이 개인정보의
						수집 및 이용 목적, 개인정보의 항목, 개인정보의 보유 및 이용기간을 안내해 드립니다.</p>
				</details>
				...
				<details id="tradeInfoDetails">
					...
					<p style="font-size: 12px;">
						개인정보 수집 이용 동의(필수)<br>
						<br> 수집하는 개인정보 항목<br>이름, 아이디, 비밀번호, 휴대폰번호, 주소<br>
						<br> 수집 및 이용목적<br>회원제 가입 서비스 제공, 계약이행을 위한 연락, 민원 및 고충 처리<br>
						<br> 보유 및 이용기간<br>회원탈퇴시까지
					</p>
				</details>
