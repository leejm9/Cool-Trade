  ...
  <body>
    ...
    <div class="outer">
      ...
      <div id="div-find-pwd">
        ...
        <button class="submitbtn" type="button" onclick="btnFindPwd()">
          제출
        </button>
        <br /><br />
        <p style="text-align: center; font-size: 12px; margin: 0">
          아이디가 기억나지 않는다면? &nbsp;
          <a href="/cooltrade/searchid.me" class="abtn" style="font-size: 13px"
            >아이디 찾기</a
          >
        </p>
      </div>
      ...
      <div id="div-input-pwd" style="display: none">
        ...
        <button type="button" class="submitbtn" onclick="btnChangePwd()">
          비밀번호 변경
        </button>
      </div>
    </div>
