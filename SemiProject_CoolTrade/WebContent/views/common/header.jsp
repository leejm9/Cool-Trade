...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<% String contextPath = request.getContextPath(); int headerCo; Member loginUser =
				...
				<div id="headerSearch-ds" class="flex-ds">
					...
					<div id="chatSell-ds" class="flex-ds">
						<div id="chatContainer-ds">
							<a href="<%= contextPath %>/chatRoom.list" id="chat-ds"> <img
								src="resources/images/말풍선.png" alt="말풍선 이미지" />
								채팅하기
							</a>
						</div>
