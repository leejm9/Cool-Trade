    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<%=contextPath %>/onload.page">
                ...
                <div class="sidebar-brand-text mx-3" >쿨거래</div>
            </a>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="<%= contextPath %>/manager.in">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="<%= contextPath %>/chart.in">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="<%= contextPath %>/search.in">
                    <i class="fas fa-fw fa-table"></i>
                    <span>인기검색어 조회</span></a>
            </li>
