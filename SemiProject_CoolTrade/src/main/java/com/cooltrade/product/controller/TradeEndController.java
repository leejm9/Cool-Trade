...
/**
 * Servlet implementation class TradeEndController
 */
@WebServlet("/ajaxtrade.complete")
public class TradeEndController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TradeEndController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = new ProductService().endTrade(pno);
		if(result>0){
